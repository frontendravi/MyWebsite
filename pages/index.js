...
export default function Home({ publications }) {
  ...
  return (
    <div className="bg-white dark:bg-darker transition-all duration-150 ease-in-out">
      ...
      >
        <Head>
          <title>Ravi Sharma | Frontend Developer & Designer</title>
          <meta
            name="description"
            content="The portfolio of frontend developer and designer, Ravi Sharma"
          />
            ...
            <nav className="block ml-auto">
              <ul className="z-50 flex flex-col items-start">
                ...
                <li className="z-40 block py-2 mt-6 list-none lg:inline-block">
                  <a
                    href={`mailto:rsdesign95@gmail.com`}
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col-reverse items-start w-full md:flex-row">
                <div className="flex flex-col w-full md:pr-8 md:w-3/5">
                  <p className="text-lg">
                    Hello! I&apos;m Ravi and I&apos;m a frontend developer,
                    designer and teacher from Punjab, India.
                  </p>
                  <p className="text-lg">
                    After building my first website aged eighteen, I knew I
                    wanted to work with computers and technology, and I&apos;ve
                    never looked back.
                  </p>
                  <p className="text-lg">
                    After graduating University with a Arts degree, I began
                    freelancing as a designer, creating graphics,
                ...
                <div className="flex w-full h-full mb-4 md:pl-8 md:w-2/5 md:mb-0">
                  <Image
                    src="/headshot-with-frame-2_1.jpg"
                    className="overflow-hidden rounded-md"
                    width={880}
                    height={880}
                    alt={"Ravi Sharma headshot"}
                  />
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex flex-col w-full mb-12">
              ...
              <FeaturedProjectCard
                ...
                description={`I designed and developed the website for Gulf Kaam, a platform focused on connecting job seekers with opportunities across the Gulf region. `}
                float={`right-0`}
                flexDirection={`flex-col lg:flex-row`}
                imgWidth={"1366"}
                imgHeight={"666"}
                imgSrc={"/projects/gulf.png"}
                liveLink={"https://www.gulfkaam.com/"}
                repoLink={null}
                stack={
                  <>
                    <Icon
              ...
              <FeaturedProjectCard
                title={"Gorilla bow"}
                status={"Open Source"}
                description={`The design focused on creating an engaging, high-energy user experience, emphasizing the brand’s unique product offerings. `}
                float={`right-0`}
                flexDirection={`flex-col lg:flex-row`}
                imgWidth={"1366"}
                imgHeight={"666"}
                imgSrc={"/projects/gorilla.png"}
                liveLink={"https://www.gorillabow.com/"}
                repoLink={""}
                stack={
                  <>
                    <Icon
          ...
          <footer className="flex flex-col w-full px-0 py-16 md:px-20 lg:px-24 section">
            ...
            <div className="flex flex-col items-start md:flex-row">
              <p className="w-auto mb-4 md:mb-0">
                &copy; {new Date().getFullYear()} - Designed and built by Ravi Sharma
              </p>
